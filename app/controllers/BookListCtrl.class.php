...
class PersonListCtrl {
    ...
    public function action_bookList() {
        ...
        if (isset($this->form->id_books) && strlen($this->form->id_books) > 0) {
            $search_params['id_books[~]'] = $this->form->id_books . '%'; // dodanie symbolu % zastępuje dowolny ciąg znaków na końcu
        }
